    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4 py-24">
      <div className="w-full max-w-md">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-medium tracking-tight mb-2 text-black">Create Account</h2>
          <p className="text-gray-500 font-light">Join us to explore premium collections.</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-5">
          <div>
            <label className="block text-xs font-bold tracking-widest uppercase text-black mb-2">Full Name</label>
          ...
          <div>
            <label className="block text-xs font-bold tracking-widest uppercase text-black mb-2">Photo URL (Optional)</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          <button
            type="submit"
            className="w-full bg-black text-white py-4 mt-4 text-sm font-bold tracking-widest uppercase hover:bg-gray-800 transition-colors disabled:bg-gray-300 disabled:text-gray-500"
